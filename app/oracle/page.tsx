...
import { Shield, Eye, Database, GitBranch } from 'lucide-react'
...
export default function Oracle() {
  ...
  useEffect(() => {
    ...
    return () => {
      Object.values(sectionRefs.current).forEach((ref) => ref && observer.unobserve(ref))
    }
  }, [])
      ...
      <div className="pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div
            ...
            id="functions"
            className={`mb-20 transition-all duration-1000 ease-out ${visibleSections.has("functions") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
                ...
                return (
                  <div
                    ...
                    className={`p-6 border-2 rounded-lg cursor-pointer transition-all duration-300 ${
                      activeFeature === index ? "border-black bg-black text-white" : "border-gray-300 bg-white hover:border-gray-500"
                    }`}
            ...
            <div className="bg-gray-50 p-8 rounded-lg border-2 border-black">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {oracleFeatures[activeFeature].details.map((detail, idx) => (
          ...
          <div
            ...
            id="declaration"
            className={`mb-20 transition-all duration-1000 ease-out ${visibleSections.has("declaration") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <h2 className="text-3xl font-bold text-center mb-12">Agent Identity Declaration</h2>
            <p className="text-center text-gray-600 mb-8 max-w-3xl mx-auto">
              Every AI agent must declare its identity, capabilities, and constraints before establishing trust. Here’s an example:
            </p>
          ...
          >
            <div className="bg-black text-white p-8 rounded-lg">
              ...
              <p className="text-xl mb-6 opacity-90">Dive deeper into the technology behind SYMBI’s trust infrastructure</p>
